package com.ncourses.authuser.clients;

import com.ncourses.authuser.dto.CourseDto;
import com.ncourses.authuser.dto.ResponsePageDto;
...
public class CourseClient {
    ...
    public Page<CourseDto> getAllCoursesByUser(UUID userId, Pageable pageable, String token) {
        ...
        String url = REQUEST_URL_COURSE + createUrlGetAllCoursesByUser(userId, pageable);
    ...
    private String createUrlGetAllCoursesByUser(UUID userId, Pageable pageable) {
